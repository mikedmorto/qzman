/*
    ...
    Updated by ToriSakuraTeam in 2013 year
...
void critical(QWidget *parent, const QString &title,
             const QString &text, const QString &detailedText)
{
#if QT_VERSION >= 0x040600
    QScopedPointer<QMessageBox> messageBox(new QMessageBox(parent));
...
int YesNoCancel(QWidget *parent, const QString &title,
              const QString &text, const QString &detailedText,
              const QString &yesText, const QString &noText, const QString &cancelText)
{
#if QT_VERSION >= 0x040600
    QScopedPointer<QMessageBox> messageBox(new QMessageBox(parent));
#else
    ...
    QAbstractButton *yesButton = messageBox->addButton(yesText,
            QMessageBox::YesRole);
    messageBox->addButton(noText, QMessageBox::NoRole);
    messageBox->addButton(cancelText, QMessageBox::RejectRole);
    messageBox->setDefaultButton(
            qobject_cast<QPushButton*>(yesButton));
